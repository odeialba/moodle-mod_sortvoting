...
$string['privacy:metadata:sortvoting_answers'] = 'Information about the user\'s votes for a given Sort Voting activity';
$string['privacy:metadata:sortvoting_answers:sortvotingid'] = 'The ID of the Sort Voting activity';
$string['privacy:metadata:sortvoting_answers:optionid'] = 'The ID of the option that the user sorted.';
$string['privacy:metadata:sortvoting_answers:userid'] = 'The ID of the user answering this Sort Voting activity';
